...
import { feedingSessionsToCsv, eventsToCsv, downloadCsv } from "@/utils/csv-export"
    ...
    try {
      ...
      if (sessionsArray.length === 0) {
        toast({
          ...
          description: "Es sind keine Stillzeiten vorhanden, die exportiert werden können.",
          variant: "destructive",
        })
        return
      }
  ...
  const handleExportEvents = async () => {
    try {
      ...
      if (eventsArray.length === 0) {
        toast({
          title: "Keine Daten zum Exportieren",
          description: "Es sind keine Ereignisse vorhanden, die exportiert werden können.",
          variant: "destructive",
        })
        return
      }
