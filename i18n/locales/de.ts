export const de = {
  ...
  diaperBrandsByLeakage: "Windelmarken nach Auslaufhäufigkeit (mind. 3 Verwendungen)",
  ...
  noMeasurementsForGrowthChart: "Noch keine Messungen vorhanden. Füge Messungen hinzu, um die Wachstumskurve zu sehen.",
